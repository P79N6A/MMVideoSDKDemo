...
#define kBottomButtonMargin (MDScreenWidth -kViewLeftRightMargin *2 -kBottomToolButtonWidth *5) / 4
...
//            [self.view addSubview:alertModelView];
//
//            self.doneBtn.hidden = YES;
//            self.qualityBlockBtn.hidden = NO;
//            return;
//        }
...
//            [self.view addSubview:alertModelView];
//
//            self.qualityBlockBtn.hidden = YES;
//            return;
//        }
...
- (void)doneButtonTapped
{
    ...
    UIImage *renderedImage = [UIImage imageFromPixelBuffer:self.renderedPixelBuffer context:nil];
...
//            NSInteger currentFilterIndex = self.currentFilterIndex;
...
- (CGRect)renderFrame
{
    ...
    if (_originImage.size.width > 0 && _originImage.size.height > 0) {
        
        CGFloat widthRatio = _originImage.size.width/MDScreenWidth;
        CGFloat heightRatio = _originImage.size.height/MDScreenHeight;
        CGFloat imageRatio = _originImage.size.width/_originImage.size.height;
